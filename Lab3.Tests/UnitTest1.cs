...
namespace Lab3.Tests
{
    public class UnitTest1
    {
        ...
        public void Test1()
        {
            ...
            Assert.Equal("Мегрэ и человек на скамейке", foundBooks.ElementAt(0).Title);
            Assert.Equal("Мегрэ и старая дама", foundBooks.ElementAt(1).Title);
            Assert.Equal("Мегрэ колеблется", foundBooks.ElementAt(2).Title);
            ...
            Assert.Equal(2, foundBooks.Count());
            Assert.Equal("Лунный камень", foundBooks.ElementAt(0).Title);
            Assert.Equal("Женщина в белом", foundBooks.ElementAt(1).Title);
            ...
            Assert.Equal("Мегрэ и старая дама", foundBooksResult.ElementAt(0).Book.Title);//3 совпадения
            Assert.Equal("Мегрэ и человек на скамейке", foundBooksResult.ElementAt(1).Book.Title);//2 совпадения
            Assert.Equal("Мегрэ колеблется", foundBooksResult.ElementAt(2).Book.Title);//2 совпадения
            Assert.Equal("Смерть Сесили", foundBooksResult.ElementAt(3).Book.Title);//2 совпадения
            Assert.Equal("Лунный камень", foundBooksResult.ElementAt(4).Book.Title);//1 совпадение
            Assert.Equal("Женщина в белом", foundBooksResult.ElementAt(5).Book.Title);//1 совпадение
